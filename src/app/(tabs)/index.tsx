...
const styles = StyleSheet.create({
  ...
  menuDismissLayer: { ...StyleSheet.absoluteFill, zIndex: 4 },
  ...
  moreMediaOverlay: { ...StyleSheet.absoluteFill, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.56)' },
